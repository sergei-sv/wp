...
<div class='content-html'>
  <?php echo esc_html(get_theme_mod('open_shop_col1_texthtml',  __( 'Add your content here', 'th-open' )));?>
</div>
...
<a href="<?php echo esc_url( admin_url( 'nav-menus.php' ) ); ?>"><?php esc_html_e( 'Assign Above header menu', 'th-open' );?></a>
 <?php }
  ...
  <div class="content-widget">
    ...
    dynamic_sidebar('top-header-widget-col1' );
      ...
      <a href="<?php echo esc_url( admin_url( 'widgets.php' ) ); ?>"><?php esc_html_e( 'Add Widget', 'th-open' );?></a>
     <?php }?>
     </div>
...
<?php if($content=='text'){?>
<div class='content-html'>
  <?php echo esc_html(get_theme_mod('open_shop_col2_texthtml',  __( 'Add your content here', 'th-open' )));?>
</div>
<?php }elseif($content=='menu'){
  if ( has_nav_menu('open-shop-above-menu' ) ){?>
<!-- Menu Toggle btn-->
...
<?php if($content=='text'){?>
<div class='content-html'>
  <?php echo esc_html(get_theme_mod('open_shop_col3_texthtml',  __( 'Add your content here', 'th-open' )));?>
</div>
<?php }elseif($content=='menu'){
  if ( has_nav_menu('open-shop-above-menu' ) ){?>
<!-- Menu Toggle btn-->
...
$open_shop_menu_open = get_theme_mod('open_shop_mobile_menu_open','left');
$main_header_layout = get_theme_mod('open_shop_main_header_layout','mhdrthree');
?> 
<div class="below-header  <?php echo esc_attr($main_header_layout);?> <?php echo esc_attr($open_shop_menu_alignment);?>">
      <div class="container">
            ...
            <div class="menu-category-list">
              <div class="toggle-cat-wrap">
                  <p class="cat-toggle">
                    ...
                    <span class="toggle-title"><?php _e('Category','th-open');?></span>
...
$open_shop_menu_open = get_theme_mod('open_shop_mobile_menu_open','left');
?>
<div class="main-header <?php echo esc_attr($main_header_layout);?> <?php echo esc_attr($main_header_opt);?> <?php echo esc_attr($open_shop_menu_alignment);?> ">
      <div class="container">
...
function open_shop_main_header_optn(){
          ...
          <a href="<?php echo esc_url(get_theme_mod('open_shop_main_hdr_btn_lnk','#')); ?>" class="btn-main-header"><?php echo esc_html(get_theme_mod('open_shop_main_hdr_btn_txt', __('Button Text','th-open'))); ?></a>
          <?php }
          ...
          <div class="header-support-wrap">
              ...
              <div class="header-support-content">
                <span class="sprt-tel"><b><?php echo esc_html(get_theme_mod('open_shop_main_hdr_calto_txt',__('Call To','th-open'))); ?></b> <a href="tel:<?php echo esc_attr(get_theme_mod('open_shop_main_hdr_calto_nub',__('+1800090098','th-open'))); ?>"><?php echo esc_html(get_theme_mod('open_shop_main_hdr_calto_nub',__('+1800090098','th-open'))); ?></a></span>
                <span class="sprt-eml"><?php _e('Email :','th-open');?> <a href="mailto:<?php echo esc_attr(get_theme_mod('open_shop_main_hdr_calto_email',__('Info@gmail.com','th-open'))); ?>"><?php echo esc_html(get_theme_mod('open_shop_main_hdr_calto_email',__('Info@gmail.com','th-open'))); ?></a></span>
              </div>
          </div>
...
function open_shop_th_advance_product_search(){
              ...
              if ( shortcode_exists('th-aps') ){
                ...
                <a target="_blank" class="plugin-active-msg" href="<?php echo esc_url($url);?>">
                  ...
                  <?php _e('Please Install "th advance product search" Plugin','th-open');?>
